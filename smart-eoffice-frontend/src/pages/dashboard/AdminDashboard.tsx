  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardHeader
        ...
        subtitle="SITA platform-wide governance metrics, user quotas, and system audit log activity."
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <Card className="space-y-4 bg-[#ECEAE3]">
            <h3 className="text-base font-semibold text-[#292A27]">System Health & Capacity</h3>
          ...
          <Card className="space-y-3 bg-[#F9F8F5]">
            ...
            <p className="text-xs text-[#6B6A64]">
              Role permissions enforce system security. Manage users and departments from the left navigation bar.
            </p>
          </Card>
        </div>
      </div>
