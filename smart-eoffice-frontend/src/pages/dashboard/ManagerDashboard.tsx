  ...
  return (
    <div className="space-y-6">
      ...
      <DashboardHeader
        ...
        subtitle="Review pending approvals, monitor unit document processing, and manage workflow approvals."
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left 2 Cols: Documents Requiring Approval */}
        <div className="lg:col-span-2">
          <RecentDocumentsTable
            documents={data.pendingApprovals}
            title="Pending Approval Queue"
            subtitle="Documents awaiting sign-off and verification"
            emptyTitle="No Pending Approvals"
            emptyDescription="All submitted department documents have been processed."
          />
        </div>
