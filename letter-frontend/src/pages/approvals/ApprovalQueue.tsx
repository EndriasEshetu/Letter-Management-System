  ...
  if (!isAuthorized) {
    return (
      <AccessDenied
        ...
        description="The Approval Queue is reserved for Department Managers and Administrators."
        role={user?.role}
      />
    );
  }
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-[#6B6A64] mt-1">
            Review and authorize pending letter submissions across your department.
          </p>
        </div>
              ...
              <EmptyState
                ...
                description={
                  activeTab === 'HIGH_PRIORITY'
                    ...
                    : 'All submitted letter approval requests have been reviewed and processed.'
                }
              />
            ) : (
