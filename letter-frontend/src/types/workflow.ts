...
export const WORKFLOW_STEPS_INCOMING: WorkflowStepDef[] = [
  {
    ...
    description:
      "Receive, verify, scan/upload, assign registration number, classify, set priority & confidentiality, route to Main Administrator.",
  ...
  },
  {
    ...
    description:
      "Review registration info, determine destination department, and route letter to appropriate department manager.",
  ...
  },
  {
    ...
    description:
      "Review incoming letter, select responsible officer, provide instructions, and set response deadline.",
  ...
  },
  {
    ...
    description:
      "Process requested action. If response is required, prepare outgoing response draft and submit to manager.",
  ...
  },
  {
    ...
    actorLabel: "Department Manager",
    description:
      "Review prepared response letter. Approve, request revisions, or reject response.",
    possibleStatuses: [
      "PENDING_APPROVAL",
      "APPROVED",
      "CHANGES_REQUESTED",
  ...
  },
  {
    ...
    description:
      "Register outgoing response, assign outgoing reference number, record dispatch date & method, dispatch response.",
  ...
  },
  {
    ...
    description:
      "Mark correspondence workflow complete, file in official archives, apply retention rules.",
...
export const WORKFLOW_STEPS_OUTGOING: WorkflowStepDef[] = [
  {
    ...
    description:
      "Create outgoing draft, fill recipient details, attach supporting files, set priority & confidentiality, submit for manager review.",
  ...
  },
  {
    ...
    actorLabel: "Department Manager",
    description:
      "Verify letter content, recipient, attachments. Approve or request changes.",
  ...
  },
  {
    ...
    actorLabel: "Main Administrator",
    description:
      "Verify administrative info, confirm required sign-offs, assign official outgoing reference number (e.g. OUT/2026/00891), route to dispatch.",
    possibleStatuses: ["REGISTERED"],
  ...
  },
  {
    ...
    actorLabel: "Registry / Dispatch Officer",
    description:
      "Record dispatch method, dispatch date, courier reference, upload delivery evidence when available.",
...
export const WORKFLOW_STEPS_INTERNAL: WorkflowStepDef[] = [
  {
    ...
    description:
      "Select destination department/unit, set subject, content, attachments, priority, submit to sending manager.",
    possibleStatuses: ["DRAFT"],
    actions: ["SUBMIT_FOR_REVIEW"],
  },
  {
    ...
    description:
      "Review internal communication, request changes, or approve for transmission.",
    possibleStatuses: ["PENDING_REVIEW", "APPROVED", "CHANGES_REQUESTED"],
    actions: ["APPROVE", "REQUEST_CHANGES"],
  },
  {
    ...
    actorLabel: "Main Administrator",
    description:
      "Verify destination, assign internal reference number (e.g. INT/2026/00317), route to receiving department.",
    possibleStatuses: ["REGISTERED"],
    actions: ["ROUTE_TO_DEPARTMENT"],
  },
  {
    ...
    description:
      "Receive internal letter, assign to officer, set instructions & deadline.",
  ...
  },
  {
    ...
    description:
      "Process request, attach supporting results, complete assigned task.",
    possibleStatuses: ["IN_PROGRESS"],
  ...
  },
  {
    ...
    description:
      "Verify request was properly handled, close internal workflow, move to archive.",
    possibleStatuses: ["COMPLETED", "ARCHIVED"],
    actions: ["MARK_COMPLETED", "ARCHIVE"],
  },
];
