    ...
    return {
      ...
      recentActivities: [
        ...
        },
        {
          ...
          target: 'ICT Infrastructure Development Directorate',
    ...
    return {
      ...
      recentActivities: [
        ...
        },
        {
          ...
          target: 'IN/2026/00452 → ICT Infrastructure Development Directorate',
          timestamp: '2 hours ago',
          type: 'approval',
        },
      ],
    ...
    return {
      ...
      pendingApprovals: [
        ...
        },
        {
          ...
          department: 'Incubation Development Directorate',
          status: 'PENDING_APPROVAL',
          date: 'Oct 21, 2026',
