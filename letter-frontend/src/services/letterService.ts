...
const MOCK_LETTERS: LetterItem[] = [
  {
    ...
    assignment: {
      ...
      dueDate: 'Sep 02, 2026',
      instructions: 'Prepare detailed status report on SITA infrastructure migration and budget deployment for Q4.',
      priority: 'HIGH',
    ...
    movements: [
      ...
      },
      {
        ...
        comment: 'Assigned to Infrastructure Directorate for technical preparation.',
      },
      {
        id: 'mov-4',
  ...
  },
  {
    ...
    description: 'Internal communication from App Development Directorate to ICT Infrastructure Development Directorate for datacenter server deployment.',
    ...
    assignment: {
      ...
      dueDate: 'Sep 10, 2026',
      instructions: 'Process deployment request for 4 cloud application servers.',
    },
    movements: [
      {
        id: 'mov-3-1',
      ...
      },
      {
        ...
        actorName: 'Main Administrator',
        actorRole: 'ADMIN',
        action: 'Registered & Routed to ICT Infrastructure Directorate (Ref: INT/2026/00317)',
