...
const MOCK_AUDIT_LOGS: AuditLog[] = [
  {
    ...
    user_id: 'usr-102',
    user_name: 'Abebe Demissie',
    user_email: 'abebe.d@sita.gov.et',
    user_role: 'REGISTRY_OFFICER',
    action: 'LETTER_REGISTERED',
    entity_type: 'LETTER',
    entity_id: 'IN/2026/00501',
    ip_address: '192.168.1.45',
    details: JSON.stringify({ subject: 'Annual Compliance Audit Notification FY2026', sender: 'Office of Auditor General' }),
  },
  {
    id: 'aud-002',
    created_at: new Date(Date.now() - 20 * 60 * 1000).toISOString(),
    user_id: 'usr-101',
    user_name: 'Main Administrator',
    user_email: 'admin@sita.gov.et',
    user_role: 'ADMIN',
  ...
  },
  {
    ...
    entity_id: 'IN/2026/00452',
    ip_address: '192.168.1.45',
    details: JSON.stringify({ assigned_to: 'Endrias Eshetu', due_date: 'Sep 02, 2026' }),
  },
  {
    id: 'aud-004',
